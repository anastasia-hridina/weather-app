...
function LocationWeather({ weather: { name, country, description, icon, temp } }) {
    ...
    return (
        <div className="pt-12 pl-10 flex justify-between pb-12 max-[576px]:flex-col max-[576px]:items-center max-[576px]:text-center max-[576px]:pl-0 max-[576px]:pb-10">
            <div className="max-[576px]:pb-6">
                <h3 className="text-5xl font-bold tracking-wide">{`${name}, ${country}`}</h3>
                <p className="pt-4 pb-12 text-lg text-gray-400 tracking-wide max-[576px]:pb-10">{description}</p>
